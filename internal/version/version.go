...
//
//	-ldflags "-X github.com/magos/lyceum/internal/version.Version=1.10.0 \
//	          -X github.com/magos/lyceum/internal/version.Commit=<40-char sha>"
//
...
// docker/metadata-action stamps WITHOUT the prefix. Report "v1.10.0" against a
// label of "1.10.0" and every deploy report is filed `claimed_not_confirmed`
